...
context master {
    ...
    entity product{
        ...
        TYPE_CODE: String(2);
        CATEGORY: String(32);
        DESCRIPTION: localized String(255) @title : '{i18n>PRODUCT_DESCRIPTION}';
...
context transaction {
    ...
    entity poitems: common.Amount, cuid{
       // key NODE_KEY: common.Guid @title : '{i18n>PRODUCT_DESCRIPTION}';
        PARENT_KEY: Association to purchaseorder @title : '{i18n>PO_ITEM_KEY}';
        PO_ITEM_POS: Integer @title : '{i18n>PO_ITEM_NO}';
